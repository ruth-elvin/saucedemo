...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/body_You need to enable JavaScript to run t_052c49'))

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_firstName'), 'asdfg')
