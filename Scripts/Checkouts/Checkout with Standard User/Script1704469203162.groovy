...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_firstName'), 'aba')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_lastName'), 'bar')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_postalCode'), '1234')
