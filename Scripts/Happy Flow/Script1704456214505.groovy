...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_firstName'), 'Test')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_lastName'), '123')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_postalCode'), '098765')

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/input_continue'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/span_Checkout Overview'))
